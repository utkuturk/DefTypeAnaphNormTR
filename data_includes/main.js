...
newTrial(
    ...
    newScale("scale", "1","2","3","4","5","6","7")
        .labelsPosition("top")
        .keys()
        .before(newText("scale_left", "hiç tipik değil").css("margin-left", "1em").css("margin-top", "2.5em"))
        .after(newText("scale_right", "fazlasıyla tipik").css("margin-right", "1em").css("margin-top", "2.5em"))
        .center()
        .bold()
        .css("margin", "10pt")
